...
public class GSLayerEncoderTest {
  ...
  public void setup() {
    ...
    layerEncoder.addAuthorityURL(new GSAuthorityURLInfoEncoder("authority1", "http://www.authority1.org"));
    layerEncoder.addIdentifier(new GSIdentifierInfoEncoder("authority1", "identifier1"));
  }
  ...
  public void testProperties() {
    ...
    Assert.assertEquals(true, Boolean.parseBoolean(layerEncoder.getRoot().getChild("advertised").getValue()));
  }
  ...
  public void testAuthorityURL() {
    Element el = (Element) layerEncoder.getRoot().getChild("authorityURLs").getChildren().get(0);
    Assert.assertEquals("authority1", el.getChild("name").getValue());
    Assert.assertEquals("http://www.authority1.org", el.getChild("href").getValue());
  }
  
  @Test
  public void testIdentifier() {
    Element el = (Element) layerEncoder.getRoot().getChild("identifiers").getChildren().get(0);
