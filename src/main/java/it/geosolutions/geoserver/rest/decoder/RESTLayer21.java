...
/**
 * Parse <TT>Layer</TT>s returned as XML REST objects. Applicable to GS 2.1 for decoding: - AuthorityURLs - Identifiers - advertised property value
 * 
 * <P>
...
public class RESTLayer21 extends RESTLayer {
  ...
  public static RESTLayer21 build(String response) {
    ...
    if (pb != null) return new RESTLayer21(pb);
    else return null;
  }
