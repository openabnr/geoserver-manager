...
public class VersionDecoderTest extends GeoserverRESTTest {
  ...
  private final String version = "<about><resource name=\"GeoServer\"><Build-Timestamp>10-Oct-2013 03:08</Build-Timestamp>" + "<Git-Revision>32db076555e57cc5f826b0361d1af4efe6d3f01b</Git-Revision><Version>2.2-ENTERPRISE-SNAPSHOT</Version></resource></about>";
  ...
  public void testIntegrationVersionDecoder() {
    ...
    } else if (GSVersionDecoder.VERSION.UNRECOGNIZED.equals(GSVersionDecoder.VERSION.getVersion(GS_VERSION))) {
