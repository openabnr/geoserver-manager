...
public class GSLayerEncoder21Test {
  ...
  public void setup() {
    ...
    layerEncoder.addAuthorityURL(new GSAuthorityURLInfoEncoder("authority2", "http://www.authority2.org"));
    layerEncoder.addIdentifier(new GSIdentifierInfoEncoder("authority2", "identifier2"));
    layerEncoder.addIdentifier(new GSIdentifierInfoEncoder("authority2", "additionalId"));
  }
